...
// transmit interrupts
void serial_midi_send_usart1(MidiDevice *device, uint16_t cnt, uint8_t inByte0,
                             uint8_t inByte1, uint8_t inByte2)
{
...
void serial_midi_send_usart0(MidiDevice *device, uint16_t cnt, uint8_t inByte0,
                             uint8_t inByte1, uint8_t inByte2)
{
...
MidiDevice *serial_midi_init_usart0(uint16_t clockScale, bool out, bool in)
{
    ...
    bytequeue_init(&queue_usart0, output_queue_data_usart0,
                   MIDI_OUTPUT_QUEUE_LENGTH);
...
MidiDevice *serial_midi_init_usart1(uint16_t clockScale, bool out, bool in)
{
    ...
    bytequeue_init(&queue_usart1, output_queue_data_usart1,
                   MIDI_OUTPUT_QUEUE_LENGTH);
